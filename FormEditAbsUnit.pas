...
uses
  ...
  ImgList, Controls, Classes, ActnList, cxGridLevel, cxGridCustomView,
...
type
  TFormEditAbs = class(TForm)
    ...
    dxLayoutMainGroup_Root: TdxLayoutGroup;
    dxLayoutMain: TdxLayoutControl;
...
procedure TFormEditAbs.FormKeyPress(Sender: TObject; var Key: Char);
begin
  case Key of
    chr(Key_Escape): acCancelExecute(Sender);
  end;
end;
